...
This project currently targets **Java 21**.

Use **Java 21 or higher** where possible. If the project is updated to use a newer JDK, make sure the full automation suite still runs successfully before committing the change.
...
- Make sure the project SDK is set to Java 21 or higher.
