...
/**
 * Read-only data access used by {@link SavingsChatTools}: each method here backs one
 ...
 * endpoints use, so figures shown in chat match what the customer sees elsewhere.
 */
@Service
